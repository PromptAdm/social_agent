    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'border-[#27273A] bg-[#111118] text-slate-500 hover:border-[#3F3F56] hover:text-slate-400',
        className,
      )}
    >
      {children}
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          <div className="h-5 w-16 bg-[#27273A] rounded-full" />
          <div className="h-5 w-20 bg-[#27273A] rounded-full" />
        </div>
        <div className="h-5 w-10 bg-[#1E1E2A] rounded" />
      </div>
      <div className="h-5 w-3/4 bg-[#27273A] rounded" />
      <div className="space-y-1.5">
        <div className="h-3.5 w-full bg-[#1E1E2A] rounded" />
        <div className="h-3.5 w-5/6 bg-[#1E1E2A] rounded" />
        <div className="h-3.5 w-4/6 bg-[#1E1E2A] rounded" />
      </div>
      <div className="h-9 bg-[#1E1E2A] rounded-md mt-2" />
      <div className="flex gap-2 pt-1 border-t border-[#1E1E2A]">
        <div className="h-7 flex-1 bg-[#1E1E2A] rounded-md" />
        <div className="h-7 flex-1 bg-[#1E1E2A] rounded-md" />
        <div className="h-7 w-8 bg-[#1E1E2A] rounded-md" />
      </div>
    </div>
  )
}
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center flex-wrap gap-1.5">
          {/* Index */}
          <span className="text-[10px] font-bold text-slate-600 bg-[#17171F] border border-[#27273A] rounded px-1.5 py-0.5">
          ...
          {/* Format chip */}
          <span className="text-[11px] text-slate-400 bg-[#17171F] border border-[#27273A] px-2 py-0.5 rounded-full">
      ...
      {/* Title */}
      <h3 className={cn(
        'text-[15px] font-semibold text-slate-100 leading-snug',
      ...
      {/* Actions */}
      {!converted && (
        <div className="flex items-center gap-2 pt-1 border-t border-[#1E1E2A]">
          <button
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-md border border-[#27273A] bg-transparent hover:border-red-500/40 hover:bg-red-500/8 hover:text-red-400 text-slate-500 text-xs font-medium transition-all"
...
export default function GeneratePage() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <aside className="w-[420px] flex-shrink-0 border-r border-[#1E1E2A] flex flex-col overflow-y-auto bg-[#0C0C11]">

        {/* Panel header */}
        <div className="px-6 py-5 border-b border-[#1E1E2A] flex-shrink-0">
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <h1 className="text-[15px] font-semibold text-slate-100">Gerar Conteúdo</h1>
          </div>
        ...
        <div className="px-6 py-4 border-t border-[#1E1E2A] flex-shrink-0 bg-[#0C0C11]">
          {!canGenerate && (
            <div className="flex items-center gap-2 mb-3 px-3 py-2 rounded-md bg-[#111118] border border-[#27273A]">
      ...
      {/* ── Right: Results Panel ───────────────────────────────────────────────── */}
      <main ref={resultsRef} className="flex-1 overflow-y-auto bg-[#09090E]">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-8">
            ...
            <div className="flex flex-wrap justify-center gap-2 max-w-sm">
              {[
                ...
                <span key={f} className="text-[11px] text-slate-600 bg-[#111118] border border-[#1E1E2A] px-2.5 py-1 rounded-full">
                  {f}
                </span>
              ))}
            </div>
        ...
        {genState === 'results' && (
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-slate-400 hover:text-slate-200 border border-[#27273A] hover:border-[#3F3F56] rounded-md transition-all"
                >
            ...
            <div className="flex items-center flex-wrap gap-1.5 mb-5">
              {selectedBrand && (
                <span className="text-[11px] text-slate-500 bg-[#111118] border border-[#1E1E2A] px-2.5 py-1 rounded-full">
                  🏷 {selectedBrand.name}
                </span>
              )}
              {form.objetivo && (
              ...
              {form.plataforma && (
                <span className="text-[11px] text-slate-500 bg-[#111118] border border-[#1E1E2A] px-2.5 py-1 rounded-full capitalize">
                  {form.plataforma}
                </span>
              )}
              {form.formato && (
