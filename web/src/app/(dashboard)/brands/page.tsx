...
function BrandCard({ brand, onEdit, onDelete }: BrandCardProps) {
  ...
  return (
    <div className="card p-5 flex flex-col gap-4 hover:border-slate-300 transition-colors group">
      {/* Header */}
      <div className="flex items-start justify-between">
        ...
        <div ref={menuRef} className="relative flex-shrink-0">
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full mt-1 w-40 bg-slate-50 border border-slate-300 rounded-lg shadow-modal z-10 animate-fade-up overflow-hidden">
              <button
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <button
              onClick={() => setCreateOpen(true)}
              className={cn(
                'border border-dashed border-slate-300 rounded-xl p-5',
            ...
            >
              <div className={cn(
                'w-10 h-10 rounded-full border border-dashed border-slate-300',
              ...
              <div className="text-center">
                <p className="text-[13px] font-medium text-slate-500 group-hover:text-slate-700 transition-colors">
                  Adicionar marca
                </p>
